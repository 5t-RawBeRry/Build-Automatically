...
#argon主题
git clone -b main --depth 1 https://github.com/5t-RawBeRry/luci-theme-argon.git package/new/luci-theme-argon
git clone -b main --depth 1 https://github.com/5t-RawBeRry/luci-app-argon-config.git package/new/luci-app-argon-config
#edge主题
...
# sed -i 's,ispip.clang.cn/all_cn.txt,cdn.jsdelivr.net/gh/QiuSimons/Chnroute/dist/chnroute/chnroute.txt,g' package/lean/luci-app-vssr/luasrc/controller/vssr.lua
# sed -i 's,ispip.clang.cn/all_cn.txt,cdn.jsdelivr.net/gh/QiuSimons/Chnroute/dist/chnroute/chnroute.txt,g' package/lean/luci-app-vssr/root/usr/share/vssr/update.lua
#SSRP
...
# Copy banner
cp -rf ../banner package/base-files/files/etc/banner

# Set time/zone
sed -i "s/'UTC'/'CST-8'\n        set system.@system[-1].zonename='Asia\/Shanghai'/g" package/base-files/files/bin/config_generate

# Hostname
sed -i 's/OpenWrt/Sherlock/g' package/base-files/files/bin/config_generate

# SSID
sed -i 's/OpenWrt/Sherlock/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
